 ...
 * le {@link Requete#libelle} ne doit valoir que "Haut" ou "Bas" sinon la requete sera ignorer par le {@link Controleur}.
 * @author Thomas
 */
public class RequeteExterne extends Requete {
	 ...
	 * @param direction La direction que l'on souhaite prendre. Le {@link Requete#libelle} ne peut que etre "Haut" ou "Bas" sinon ignore par le {@link Controleur}.
	 */
